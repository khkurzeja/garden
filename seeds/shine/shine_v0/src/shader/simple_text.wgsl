...
struct InstanceInput {
    //**TODO: Also need rotation. Might just want a matrix?
    //        I don't want to need too much data per character though. Gotta be careful. (or maybe don't worry about it)
    //        Could also store multiple chars per render.
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    //        Passing in just one char is a bit more efficient though.
    //        And I could still add new chars here if desired.
