...
#[repr(C)]
#[derive(Debug, Copy, Clone, bytemuck::Pod, bytemuck::Zeroable)]
pub struct BasicFragUniforms {
    pub pixel_size: [f32; 4],
}
impl BasicFragUniforms {
    pub fn new() -> Self {
        Self {
            pixel_size: [0.0; 4],
        }
...
pub fn make_basic_pipeline(device: &wgpu::Device, target_format: TextureFormat, vert_uniforms: BasicVertUniforms, frag_uniforms: BasicFragUniforms) -> BasicPipeline
{
